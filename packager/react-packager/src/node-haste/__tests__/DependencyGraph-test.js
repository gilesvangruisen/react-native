...
describe('DependencyGraph', function() {
  ...
  describe('get sync dependencies (posix)', function() {
    ...
    function testBrowserField(fieldName) {
      ...
      it('should support overriding a top-level browser mapping for packages ("' + fieldName + '")', function() {
        var root = '/root';
        setMockFileSystem({
          'root': {
            'index.js': [
        ...
        return getOrderedDependenciesAsJSON(dgraph, '/root/index.js').then(function(deps) {
          expect(deps)
            .toEqual([
              ...
              { id: 'another-package/index.js',
                path: '/root/node_modules/another-package/index.js',
                dependencies: [],
                isAsset: false,
                isJSON: false,
                isPolyfill: false,
